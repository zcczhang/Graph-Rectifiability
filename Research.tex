...
\begin{equation*}
    |\centerof 3Q - q| = |\centerof Q - x + x-q| \leq \frac{\sqrt{n}\cdot\side Q}{2} + r < 3\side Q
\end{equation*}
{\color{red} but this implies $\displaystyle r < \frac{6 -\sqrt{n}}{2}\side Q$, which is impossible when $n>36$}
