...
\end{aligned}
\end{equation*}
It follows that $p\in C_{\calB}(x_1, V, \alpha)$, and as $x_1$ is arbitrary point in $Q_{E_i}$, $p\in C_\calB^2(Q_{E_i}, V, \alpha)$. Thus $C_{\calB}(y_1, V, \alpha)\subset C_\calB(Q_{E_i}, V, \alpha), \forall y_1\in E_i\in Q_{E_i}$. Then applying (\ref{muB2=0}), 
\begin{equation*}
    \begin{split}
