...
\begin{lemma}
    For $\alpha_1, \alpha_2\in(0,1), \alpha_1>\alpha_2$, a $m$-plane in $\rr^n$, a cube $Q$ with side length $2^{-|k|}$, and a cube $R$ with the same side length as $Q$, to guarantee that
    \begin{equation}\label{eq:condition}
        R\in C_\calB^{1,1}(Q, V, \alpha_1), \quad R\in  C_\calB^{1,2}(Q, V, \alpha_2)
    \end{equation}
    the distance bewteen the center of $R$ and the center of $Q$ is at least $ \displaystyle (\frac{2\sqrt{n} - 2\alpha_2}{\alpha_1-\alpha_2}-\sqrt{n})\cdot 2^{-|k|}$
\end{lemma}
\begin{proof} 
