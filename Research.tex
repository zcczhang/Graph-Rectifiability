...
\begin{lemma}
    If for $\mu$-a.e. $x\in \rr^n, \mu(B(x, 2r))\leq K\mu(B(x,r)), K\in\rr^+$, then
...
\end{lemma}
\begin{proof} By the half open definition of the dyatic cube, for $\mu$-a.e. $x\in \rr^n$, $x$ must in only one cube $Q$. Let {\color{red} $r = \side Q /2$(in $\rr^2$)}. We first claim that $5Q\subset B(x, 16r)$ and $B(x, r)\subset 3Q$. As for any $q\in 5Q$, $|\centerof Q -x|\leq \sqrt{n}\cdot\side Q /2$ and $|\centerof 5Q -q|\leq \sqrt{n}\cdot\side 5Q /2 = 5\sqrt{n}\cdot \side Q/2$, 
    \begin{equation*}
        |x-q| = |x-\centerof Q + \centerof 5Q-q | \leq 3\sqrt{n}\cdot \side Q < 16r
    \end{equation*}
Then $q\in B(x, 16r)$ and thus $5Q\subset B(x, 16r)$. Similarly, for any $q^\prime\in B(x, r)$, 
\begin{equation*}
    |\centerof 3Q - q^\prime| = |\centerof Q - x + x-q^\prime| \leq \frac{\sqrt{n}\cdot\side Q}{2} + r < \frac{1}{2}\side 3Q = \frac{3\side Q}{2}
\end{equation*}
{\color{red} but this implies $\displaystyle r < \frac{3 -\sqrt{n}}{2}\side Q$, which is impossible when $n>9$}
Then $q\in 3Q$ and thus $B(x, r)\subset 3Q$. Therefore by the containments and the doubling measure condition, 
    \begin{equation}
...
\newpage
\begin{lemma}
    For $\alpha_1, \alpha_2\in(0,1), \alpha_1>\alpha_2$, a $m$-plane $V$ in $\rr^n$, a cube $Q$ with side length $2^{-|k|}$, and a cube $R$ with the same side length as $Q$ satisfies
    \begin{equation}\label{eq:condition-GDBC-2}
        R\in C_\calB^{1,1}(Q, V, \alpha_1) \quad\text{and}\quad R\in  C_\calB^{1,2}(Q, V, \alpha_2)
    \end{equation}
    Assume $s\in \nn$ is the largest coefficients of the dilation cube such that $sQ\cap R = \emptyset$, and $t\in\nn$ such that $2sQ\subset tR$. Then
    \begin{equation}
        s = SOMETHING, \quad t = SOMETHING
    \end{equation} 
\end{lemma}
\begin{proof}
    By Lemma \ref{lemma:Guarantee-Distance-containQ-Between-2alpha}, to satisify (\ref{eq:condition-GDBC-2}), assume    
    \begin{equation*}
        \begin{split}
            d = |\centerof Q-\centerof R| \geq (\frac{2\sqrt{n} - 2\alpha_2}{\alpha_1-\alpha_2}-\sqrt{n})\cdot 2^{-|k|}
        \end{split}
    \end{equation*}
    Then, for any $q\in sQ$
\end{proof}


\begin{figure}[H]
    \centering
    \includegraphics[width=.66\textwidth]{images/tRcover2sQ.png}
...
\begin{lemma}\label{lemma:Guarantee-Distance-containQ-Between-2alpha}
    ...
    \begin{equation*}
        |\centerof Q-\centerof R|\geq (\frac{2\sqrt{n} - 2\alpha_2}{\alpha_1-\alpha_2}-\sqrt{n})\cdot 2^{-|k|}
    \end{equation*}
    to guarantee
